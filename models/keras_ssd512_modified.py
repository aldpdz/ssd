...
def ssd_512(image_size,
    ...
    def input_channel_swap(tensor):
        if len(swap_channels) == 3:
            return tf.stack([tensor[...,swap_channels[0]], tensor[...,swap_channels[1]], tensor[...,swap_channels[2]]], axis=-1)
        elif len(swap_channels) == 4:
            return tf.stack([tensor[...,swap_channels[0]], tensor[...,swap_channels[1]], tensor[...,swap_channels[2]], tensor[...,swap_channels[3]]], axis=-1)
    ...
    conv4_3_norm_mbox_conf_reshape = Lambda(lambda x: tf.reshape(x, [-1, 16384, n_classes]), name='conv4_3_norm_mbox_conf_reshape')(conv4_3_norm_mbox_conf)
    fc7_mbox_conf_reshape = Lambda(lambda x: tf.reshape(x, [-1, 6144, n_classes]), name='fc7_mbox_conf_reshape')(fc7_mbox_conf)
    conv6_2_mbox_conf_reshape = Lambda(lambda x: tf.reshape(x, [-1, 1536, n_classes]), name='conv6_2_mbox_conf_reshape')(conv6_2_mbox_conf)
    conv7_2_mbox_conf_reshape = Lambda(lambda x: tf.reshape(x, [-1, 384, n_classes]), name='conv7_2_mbox_conf_reshape')(conv7_2_mbox_conf)
    conv8_2_mbox_conf_reshape = Lambda(lambda x: tf.reshape(x, [-1, 96, n_classes]), name='conv8_2_mbox_conf_reshape')(conv8_2_mbox_conf)
    conv9_2_mbox_conf_reshape = Lambda(lambda x: tf.reshape(x, [-1, 16, n_classes]), name='conv9_2_mbox_conf_reshape')(conv9_2_mbox_conf)
    conv10_2_mbox_conf_reshape = Lambda(lambda x: tf.reshape(x, [-1, 4, n_classes]), name='conv10_2_mbox_conf_reshape')(conv10_2_mbox_conf)
    # Reshape the box predictions, yielding 3D tensors of shape `(batch, height * width * n_boxes, 4)`
    # We want the four box coordinates isolated in the last axis to compute the smooth L1 loss
    conv4_3_norm_mbox_loc_reshape = Lambda(lambda x: tf.reshape(x, [-1, 16384, 4]), name='conv4_3_norm_mbox_loc_reshape')(conv4_3_norm_mbox_loc)
    fc7_mbox_loc_reshape = Lambda(lambda x: tf.reshape(x, [-1, 6144, 4]), name='fc7_mbox_loc_reshape')(fc7_mbox_loc)
    conv6_2_mbox_loc_reshape = Lambda(lambda x: tf.reshape(x, [-1, 1536, 4]), name='conv6_2_mbox_loc_reshape')(conv6_2_mbox_loc)
    conv7_2_mbox_loc_reshape = Lambda(lambda x: tf.reshape(x, [-1, 384, 4]), name='conv7_2_mbox_loc_reshape')(conv7_2_mbox_loc)
    conv8_2_mbox_loc_reshape = Lambda(lambda x: tf.reshape(x, [-1, 96, 4]), name='conv8_2_mbox_loc_reshape')(conv8_2_mbox_loc)
    conv9_2_mbox_loc_reshape = Lambda(lambda x: tf.reshape(x, [-1, 16, 4]), name='conv9_2_mbox_loc_reshape')(conv9_2_mbox_loc)
    conv10_2_mbox_loc_reshape = Lambda(lambda x: tf.reshape(x, [-1, 4, 4]), name='conv10_2_mbox_loc_reshape')(conv10_2_mbox_loc)
    # Reshape the anchor box tensors, yielding 3D tensors of shape `(batch, height * width * n_boxes, 8)`
    conv4_3_norm_mbox_priorbox_reshape = Lambda(lambda x: tf.reshape(x, [-1, 16384, 8]), name='conv4_3_norm_mbox_priorbox_reshape')(conv4_3_norm_mbox_priorbox)
    fc7_mbox_priorbox_reshape = Lambda(lambda x: tf.reshape(x, [-1, 6144, 8]), name='fc7_mbox_priorbox_reshape')(fc7_mbox_priorbox)
    conv6_2_mbox_priorbox_reshape = Lambda(lambda x: tf.reshape(x, [-1, 1536, 8]), name='conv6_2_mbox_priorbox_reshape')(conv6_2_mbox_priorbox)
    conv7_2_mbox_priorbox_reshape = Lambda(lambda x: tf.reshape(x, [-1, 384, 8]), name='conv7_2_mbox_priorbox_reshape')(conv7_2_mbox_priorbox)
    conv8_2_mbox_priorbox_reshape = Lambda(lambda x: tf.reshape(x, [-1, 96, 8]), name='conv8_2_mbox_priorbox_reshape')(conv8_2_mbox_priorbox)
    conv9_2_mbox_priorbox_reshape = Lambda(lambda x: tf.reshape(x, [-1, 16, 8]), name='conv9_2_mbox_priorbox_reshape')(conv9_2_mbox_priorbox)
    conv10_2_mbox_priorbox_reshape = Lambda(lambda x: tf.reshape(x, [-1, 4, 8]), name='conv10_2_mbox_priorbox_reshape')(conv10_2_mbox_priorbox)
