...
#     layer = _depthwise_conv_block_f(layer, depth_multiplier,strides=(1, 1), block_id=11)
    ...
    layer, conv14_2 = liteConv(layer, 256, alpha, block_id=14)
    layer, conv15_2 = liteConv(layer, 128, alpha, block_id=15)
    layer, conv16_2 = liteConv(layer, 128, alpha, block_id=16)
    layer, conv17_2 = liteConv(layer, 64, alpha, block_id=17)
